...
public class WarehouseServiceImpl implements WarehouseService {
    ...
    public List<Warehouse> getNotAssignedWarehouses() throws RuntimeException{
        warehouseDao = WarehouseDao.getInstance();
        List<Warehouse> notAssignedWarehouseList = warehouseDao.getNotAssignedWarehouses();
        return notAssignedWarehouseList;
    }
}
